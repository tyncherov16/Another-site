(() => {
    ...
    function placeholders() {
        ...
        function input_placeholder_add(input) {
            const input_g_value = input.getAttribute("data-value");
            if ("" == input.value && "" != input_g_value) input.value = input_g_value;
        }
    ...
    function initSliders() {
        ...
        if (document.querySelector(".resources__slider")) new core(".resources__slider", {
            ...
            loop: true,
            pagination: {
                el: ".controll-resources__dotts",
                clickable: true
            },
            navigation: {
                prevEl: ".resources-arrow__prev",
                nextEl: ".resources-arrow__next"
            },
            on: {}
        });
    ...
    da.init();
    if (isMobile.any()) {
        const tipMains = document.querySelectorAll(".background__tip");
        for (let index = 0; index < tipMains.length; index++) {
            const element = tipMains[index];
            element.addEventListener("click", (function(e) {
                element.classList.toggle("_enabled");
            }));
        }
    }
    window["FLS"] = true;
